...
guild1_manual_pairs = [
    ...
    ("healot",16500),("_festashka_",56250),("rezord_aye",25070),("Chitandael",29380),("Okiarya",40400),
...
log("[2/6] Parsing guild2 (Eternal Keepers)...")
g2_parsed, g2_avatars_map, g2_profiles_map = fetch_guild(GUILD2_URL, allowed_g2, "Eternal Keepers")
...
participants_g2 = build_participants(guild2_manual_pairs, initial_g2, g2_parsed, g2_avatars_map, g2_profiles_map, "Eternal Keepers")
